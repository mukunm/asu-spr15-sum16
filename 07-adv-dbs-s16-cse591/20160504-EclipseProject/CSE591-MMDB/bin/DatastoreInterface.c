...
Java_DatastoreInterface_init_1data_1store(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jint JNICALL
Java_DatastoreInterface_write_1data(JNIEnv *env, jobject obj,
...
JNIEXPORT jint JNICALL
Java_DatastoreInterface_update_1data(JNIEnv *env, jobject obj,
...
Java_DatastoreInterface_read_1data(JNIEnv *env, jobject this_obj,
								   jint tuple_addr, jobject tuple_obj)
{
	...
	/* Set Salary */
	salary  = (jint) get_salary_field(pu1_curr_tuple);
...
JNIEXPORT void JNICALL
Java_DatastoreInterface_destroy_1data_1store(JNIEnv *env, jobject obj)
{
